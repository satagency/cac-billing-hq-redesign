...
export default function MeterInfoAndUsageData({ meter, meterData }: MeterInfoAndUsageDataProps) {
  return (
    <div className="relative w-full" data-name="Meter Info and Usage Data" data-node-id="13:600">
      <div className="box-border content-stretch flex gap-[24px] items-start max-h-inherit pb-[24px] pt-[16px] px-[16px] relative size-full">
        <div className="basis-0 content-stretch flex flex-col gap-[16px] grow h-[154px] items-start min-h-px min-w-px relative shrink-0" data-name="Meter Info" data-node-id="13:7477">
          <div className="box-border content-stretch flex flex-col gap-[16px] h-[40px] items-start px-0 py-[10px] relative shrink-0 w-full" data-name="Meter Name and ID" data-node-id="13:674">
            <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="Meter Name Container" data-node-id="13:7748">
              ...
              <div className="flex flex-col font-['Inter:Semi_Bold',_sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0380d9] text-[15px] text-nowrap tracking-[0.16px]" data-node-id="28:2987">
                <p className="[text-underline-position:from-font] decoration-solid leading-[18px] underline whitespace-pre">({meter.meterNumber})</p>
              </div>
          ...
          {/* Installed Date Container */}
          <div className="content-stretch flex flex-col gap-[20px] h-[18px] items-start justify-center relative shrink-0 w-full" data-name="Installed Date Container" data-node-id="57:1044">
            <div className="content-stretch flex gap-[5px] items-start relative shrink-0 w-[282px]" data-name="Installed Date Info" data-node-id="57:1045">
              ...
              <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0" data-name="Installed Date Details" data-node-id="57:1047">
        ...
        {/* Usage Info Section */}
        <div className="box-border content-stretch flex gap-[24px] h-[154px] items-start px-[8px] py-0 relative shrink-0 w-[646px]" data-name="Usage Info" data-node-id="13:7490">
          {/* Current Reading */}
          <div className="box-border content-stretch flex flex-col h-[140px] items-start max-w-[300px] pl-0 pr-[6px] py-0 relative shrink-0 w-[300px]" data-name="Container" data-node-id="23:2771">
            ...
            <div className="content-stretch flex flex-col h-[78px] items-start relative shrink-0 w-[300px]" data-name="Current Reading Container" data-node-id="32:3385">
              <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Region - current reading" data-node-id="23:2772">
                <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#1d2329] text-[13.711px] w-full" data-node-id="23:2773">
                  <p className="leading-[21px]">Current Reading</p>
                </div>
              </div>
              <div className="box-border content-stretch flex items-start pb-0 pt-[5.878px] px-0 relative shrink-0 w-[216px]" data-name="Region - current reading amount" data-node-id="23:2774">
                <div className="box-border content-stretch flex items-start pl-0 pr-[0.661px] py-0 relative shrink-0" data-name="Container" data-node-id="23:2775">
                  <p className="font-['Inter:Bold',_sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#1d2329] text-[20px] tracking-[0.16px] w-[216px]" data-node-id="23:2776">
                    {meterData.currentReading.toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
            <div className="content-stretch flex flex-col h-[62px] items-start relative shrink-0 w-[300px]" data-name="Usage Summary" data-node-id="23:2777">
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Usage Details" data-node-id="23:2778">
                <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Usage Row" data-node-id="23:2779">
                ...
                <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Last Reading Row" data-node-id="23:2782">
                  ...
                  <p className="font-['Inter:Medium',_sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#1d2329] text-[12px] tracking-[0.16px] w-[60px]" data-node-id="23:2784">
                    {meterData.lastReading.toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="box-border content-stretch flex flex-col h-[140px] items-start max-w-[300px] pl-[8px] pr-0 py-0 relative shrink-0 w-[300px]" data-name="Services Container" data-node-id="23:2785">
            ...
            <div className="content-stretch flex flex-col h-[62px] items-start relative shrink-0 w-[300px]" data-name="Services List" data-node-id="23:2789">
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Services Details" data-node-id="23:2790">
                {meterData.services.map((service, index) => (
